...
describe('hash', () => {
    test('should generate a hash from a string using the default algorithm (SHA-256)', async () => {
    ...
    test('should generate a hash from an object using the SHA-512 algorithm', async () => {
