...
describe('difference', () => {
    ...
    test('should return match based on input function', () => {
        expect(difference((a, b) => Math.floor(a) === Math.floor(b), [2.1, 1.2], [2.3, 3.4], [99])).toEqual([1.2]);
    });

    test('should return an array containing the elements that are present in the first array but not in the other arrays', () => {
    ...
    test('should return an empty array if no elements are present in the first array but not in the other arrays', () => {
        const array1 = [1, 2, 3, 4];
        const array2 = [1, 2];
        const array3 = [3, 4];
    ...
    test('should return the first array if no elements are present in the other arrays', () => {
        const array1 = [1, 2, 3, 4];
        const array2: number[] = [];
